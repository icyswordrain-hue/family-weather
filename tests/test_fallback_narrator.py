...
MINIMAL_PROCESSED = {
    ...
    "cardiac_alert": None,
    "menieres_alert": None,
    "outdoor_index": {"grade": "B", "label": "Good", "score": 75, "parkinsons_safe": True, "best_window": "9am–11am", "top_activity": "walking", "activity_scores": {}},
    "location_rec": {"top_locations": [{"name": "Dahan River Bikeway", "activity": "cycling", "parkinsons": "good", "notes": "Flat paved path."}], "mood": "Nice"},
